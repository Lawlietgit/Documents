...
\begin{split}
\phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rself)}(\br_f,\br_{f'})&=\frac{\rerfc(\alpha|\br_f-\br_{f'}|)-\rerfc(\delta \Rpc^{-1}|\br_f-\br_{f'}|)}{|\br_f-\br_{f'}|}\\
\phi_J^{(\rP\ l,\rcore,\rH,\rshort,\rself,\rEES)}(\br_f) & = \frac{e^2}{2}\sum_{f'} w_{f'} n_J^{(\rP\ l,\rEES)}(\br_{f'})\phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rself)}(\br_f,\br_{f'}) \\
...
\ReE \phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rself)}(\br_f,\br_{f'})&=&\frac{\rerfc(\alpha|\br_f-\br_{f'}|)-\rerfc(\delta \Rpc^{-1}|\br_f-\br_{f'}|)}{|\br_f-\br_{f'}|} \\
\phi_J^{(\rP\ l,\rcore,\rH,\rshort,\rNN,\rEES)}(\br_f) &=& \frac{e^2}{2}\sum_{<K \neq J>_\rNN}\sum_{f'}w_{f'}n_K^{(\rP\ l,\rEES)}(\br_{f'}) \phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rNN)}(\br_f,\br_{f'}) \\
\phi_J^{(\rP\ l,\rcore,\rH,\rshort,\rself,\rEES)}(\br_f) & =& \frac{e^2}{2}\sum_{f'} w_{f'} n_J^{(\rP\ l,\rEES)}(\br_{f'})\phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rself)}(\br_f,\br_{f'}) \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{phi:fHshortl}
...
where
\begin{enumerate}
\item \ReWG $A_1^{(n)}(\hs)$ is defined in Eq.\eqref{gr:A1ns}.
...
\begin{eqnarray}
\label{ReEFJb:sRPAW1SHshortAa}
\ReE \phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rNN)}(\br_f,\br_{f'}) &=& \frac{\rerfc(\alpha|\br_f-\br_{f'}-\bR_{JK}|)}{|\br_f-\br_{f'}-\bR_{JK}|} \\
\ReW \phi_J^{(\rP\ l,\rcore,\rH,\rshort,\rNN,\rEES)}(\br_f) &=& \frac{e^2}{2}\sum_{<K \neq J>_\rNN}\sum_{f'}w_{f'}n_K^{(\rP\ l,\rEES)}(\br_{f'}) \phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rNN)}(\br_f,\br_{f'}) \\
\ReW \phi_J^{(\rP\ l,\rcore,\rH,\rshort,\rself,\rEES)}(\br_f) & =& \frac{e^2}{2}\sum_{f'} w_{f'} n_J^{(\rP\ l,\rEES)}(\br_{f'})\phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rself)}(\br_f,\br_{f'}) \\
...
&\ & \hspace*{2in} \hsinJp \\
F_{J\beta}^{(R,\rP\ l,\rcore,\rH,\rshort,\rcore,\rNN,\rEES)}(\br_f)&=&\frac{e^2}{2}\sum_{f'}w_{f'}\sum_{<K \neq J>_\rNN}n_{K}^{(\rP\ l,\rEES)}(\br_f) \frac{\p \phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rNN)}(\br_f,\br_{f'})}{\p \RJb} \nonumber\\ \\
\ReE \eqref{ReEFJb:sRPAW1SHshortAa}\ \phi_{JK}^{(\rcore,\rcore,\rH,\rshort,\rNN)}(\br_f,\br_{f'}) \nonumber \\
...
\item \ReP $P^{(\rKE)}$ is defined in Eq.\eqref{terms:pre}.
\item \ReW $\phi_J^{(\rP\ 2,\rlo,\rshort)}$ is defined in Eq.\eqref{phi:PAW2locshort}.
\item \ReW $\phi_J^{(\rP\ 2,\rxc,\rA,\rEES)}$ is defined in Eq.\eqref{phi:PAW2xcA}.
\item \ReW $\phi_J^{(\rP\ 2,\rS,\rH,\rshort,\rA,\rEES)}$ is defined in Eq.\eqref{phi:PAW2SHshortA}.
\item \ReW $\phi_J^{(\rP\ 2,\rcore,\rH,\rshort,\rEES)}$ is defined in Eq.\eqref{phi:PAW2coreHshort}.
\end{enumerate}
...
\item \ReW $\phi_J^{(\rP\ 1,\rlo,\rshort,\rEES)}(\hs)$*** is defined in Eq.\eqref{phi:phiSloc}.
\item \ReW $\phi_J^{(\rP\ 1,\rlo,\rlong,\rEES)}(\hs)$*** is defined in Eq.\eqref{phi:flongSD}.
\item \ReW $\phi_J^{(\rP\ 1,\rxc,\rA,\rEES)}(\hs)$ is defined in Eq.\eqref{phi:sPAW1xcA}.
\item \ReW $\phi_J^{(\rP\ 1,\rS,\rH,\rshort,\rA,a,\rEES)}(\hs)$*** is defined in Eq.\eqref{phi:sPAW1SHshortAa}.
\item \ReW $\phi_J^{(\rP\ 1,\rcore,\rH,\rshort,\rEES)}(\hs)$*** is defined in Eq.\eqref{phi:sPAW1coreHshort}.
\item \ReW $\phi_J^{(\rP\ 1,\rtot,\rH,\rlong,\rA,\rEES)}(\hs)$*** is defined in Eq.\eqref{phi:sPAW1titHlongA}.
\end{enumerate}
